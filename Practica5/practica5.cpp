...
int main()
{
	...
	Goddard_C = Model();
	Goddard_C.LoadModel("Models/goddard_sin_patas.obj");
	Goddard_PL = Model();
	Goddard_PL.LoadModel("Models/pie_largo.obj");
	Goddard_PC = Model();
	Goddard_PC.LoadModel("Models/pie_chico.obj");
	//Carro

	Carro_C = Model();
	Carro_C.LoadModel("Models/CarroSinRuedas.obj");
	Cofre = Model();
	Cofre.LoadModel("Models/Cofre.obj");
	Rueda_D = Model();
	Rueda_D.LoadModel("Models/RuedaDerecha.obj");
	Rueda_I = Model();
	Rueda_I.LoadModel("Models/RuedaIzquierda.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Cuerpo como nodo principal
		 //modelo de goddard de color negro
		...
		model = glm::translate(model, glm::vec3(-1.2f, -0.4f, 0.6f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));
		color = glm::vec3(1.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Goddard_PL.RenderModel();
		...
		//Mandibula
		model = modelaux;
		model = glm::translate(model, glm::vec3(-3.05f, 0.9f, 0.0f));
		...
		//Cuerpo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(7.0f, 0.0f, mainWindow.getposZ()));
		modelaux = model;
		modelaux2 = model;
		color = glm::vec3(1.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//Ruedas
		model = modelaux;
		model = glm::translate(model, glm::vec3(4.0f, 1.5f, -8.0f));
		...
		//Cofre
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 5.0f, -4.5f));
