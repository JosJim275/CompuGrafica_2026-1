...
int main()
{
	...
	*/
	...
	//primer brazo que conecta con la cabina
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(3.0, 3.0f, 4.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Base junto con ruedas.
		model = modelaux2;
		model = glm::translate(model, glm::vec3(0.0f, -1.5f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(5.0, 3.0f, 3.0f));
